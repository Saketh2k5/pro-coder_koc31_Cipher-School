# -*- coding: utf-8 -*-
"""
Created on Fri Nov 25 22:07:54 2022
...
question={"In school, Albert Einstein failed most of the subjects, except for physics and math.":"Yes",
          ...
          "The first product with a bar was chewing gum":"Yes",
...
while(len(questionlist)!=5): # list of 5 questions
    ...
    if(i not in questionlist):#
        questionlist.append(i) # make a list of random questions
score=0
print(""" 8""""8                  8""""8                    
